                            ...
                            <div class="span12">
                                ...
                                <form action="read.php" method="post">
                                    ...
                                    $query = mysqli_query($conn, "
                                        ...
                                        LEFT JOIN teacher_class 
                                            ON teacher_class.teacher_class_id = teacher_class_student.teacher_class_id
                                        LEFT JOIN class 
                                            ON class.class_id = teacher_class.class_id
                                        LEFT JOIN subject 
                                            ON subject.subject_id = teacher_class.subject_id
                                        LEFT JOIN teacher 
                                            ON teacher.teacher_id = teacher_class.teacher_id  /* ✅ FIXED JOIN */
                                        JOIN notification 
                                            ON notification.teacher_class_id = teacher_class.teacher_class_id
                                        WHERE teacher_class_student.student_id = '$session_id'
                                            AND teacher_class.school_year = '$school_year'
